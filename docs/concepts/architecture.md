...
ODS-E ships with transforms for 16 OEMs (Huawei, Enphase, Solarman, SolarEdge, Fronius, SMA, Solis, SolaX, Fimer, Switch, Higeco, Sungrow BESS, BYD, Vestas, Siemens Gamesa, Nordex, Terraco) plus a generic CSV mapper for arbitrary sources.
