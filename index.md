...
<div class="sdk-links-section">
  ...
  <div class="sdk-links-grid">
    <a href="/get-started" class="sdk-link-card">
...
<div class="quick-links-section">
  ...
  <div class="quick-links-grid">
    ...
    <a href="/schemas/overview" class="quick-link-card">
      <div class="quick-link-icon">&#x1F4CB;</div>
      <h4>Schema Reference</h4>
      <p>Energy timeseries &amp; asset metadata</p>
    </a>

    <a href="/transforms/overview" class="quick-link-card">
      <div class="quick-link-icon">&#x1F504;</div>
      <h4>Transforms</h4>
      <p>10 OEM mappings</p>
    </a>

    <a href="/validation/overview" class="quick-link-card">
      <div class="quick-link-icon">&#x2705;</div>
      <h4>Validation</h4>
      <p>Schema &amp; semantic checks</p>
    </a>

    <a href="/building-integration/overview" class="quick-link-card">
      <div class="quick-link-icon">&#x1F3D7;</div>
...
#  "kWh": 4.17, "error_type": "normal"}</code></pre>
      <a href="/get-started" class="code-example-link">View Full Example &rarr;</a>
    </div>
...
print(result.is_valid)  # True</code></pre>
      <a href="/validation/overview" class="code-example-link">View Validation Guide &rarr;</a>
    </div>
  </div>
</div>
...
<div class="product-categories-section">
  ...
  <div class="product-categories-grid">
    <a href="/schemas/energy-timeseries" class="product-category-card">
      <h4>Generation</h4>
    ...
    <a href="/schemas/asset-metadata" class="product-category-card">
      <h4>Asset Taxonomy</h4>
      <p>10 asset types from solar PV to fuel cells</p>
    </a>

    <a href="/building-integration/comstock-resstock" class="product-category-card">
      <h4>Building Metadata</h4>
      <p>ComStock/ResStock-compatible fields</p>
    </a>

    <a href="/validation/overview" class="product-category-card">
      <h4>Validation</h4>
...
<div class="version-updates-section">
  <div class="version-info">
    ...
    <a href="/transforms/supported-oems" class="changelog-link">View Support Matrix &rarr;</a>
  </div>
...
<div class="sections-overview">
  ...
  <div class="section-cards">
    <div class="section-card">
      ...
      <a href="/get-started" class="section-link">Get Started &rarr;</a>
    </div>

    <div class="section-card">
      <h3>Schema Reference</h3>
      <p>Energy timeseries and asset metadata field definitions and enums</p>
      <a href="/schemas/overview" class="section-link">View Schemas &rarr;</a>
    </div>

    <div class="section-card">
      <h3>Transforms</h3>
      <p>OEM-to-ODS-E mapping specs and runtime transform functions</p>
      <a href="/transforms/overview" class="section-link">View Transforms &rarr;</a>
    </div>

    <div class="section-card">
      <h3>Validation</h3>
      <p>Schema validation, semantic checks, and physical bounds verification</p>
      <a href="/validation/overview" class="section-link">View Validation &rarr;</a>
    </div>

    <div class="section-card">
      <h3>Building Integration</h3>
      <p>Join ODS-E data to NREL ComStock/ResStock benchmarks for EUI analysis</p>
      <a href="/building-integration/overview" class="section-link">View Guide &rarr;</a>
    </div>
